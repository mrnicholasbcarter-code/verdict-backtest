...
from backtest_harness import BoundedProfitFeeModel, MonteCarloSimulator, tearsheet
...
fee_on_win = FEE_MODEL.calculate_fee(
    entry_cents=ENTRY * 100, payout_cents=PAYOUT_WIN * 100
)  # 7% of 0.50 = 0.035
...
plt.legend()
plt.tight_layout()
plt.savefig("examples/equity_cone.png")
plt.close()
