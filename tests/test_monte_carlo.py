...
class TestMonteCarloSimulator:
    def test_positive_drift_no_ruin(self):
        ...
        stats = MonteCarloSimulator.simulate_equity_paths(
            trade_returns_pct=returns, starting_equity=1000.0,
            num_simulations=100, trades_per_sim=10
        )
    ...
    def test_negative_drift_high_ruin(self):
        ...
        stats = MonteCarloSimulator.simulate_equity_paths(
            trade_returns_pct=returns, starting_equity=1000.0,
            num_simulations=200, trades_per_sim=50
        )
    ...
    def test_output_keys_present(self):
        ...
        stats = MonteCarloSimulator.simulate_equity_paths(
            trade_returns_pct=returns, starting_equity=1000.0,
            num_simulations=50, trades_per_sim=10
        )
    ...
    def test_single_trade_simulation(self):
        ...
        stats = MonteCarloSimulator.simulate_equity_paths(
            trade_returns_pct=returns, starting_equity=1000.0,
            num_simulations=10, trades_per_sim=1
        )
    ...
    def test_extreme_arrays(self):
        ...
        res_neg = MonteCarloSimulator.simulate_equity_paths(np.array([-1.0, -2.0, -5.0]), 1000.0, 10, 10)
        ...
        res_pos = MonteCarloSimulator.simulate_equity_paths(np.array([1000.0, 10000.0]), 1000.0, 10, 250)
